...
import 'package:test1/require_parts_comparison/each_item/graphics_card.dart';
import 'package:test1/require_parts_comparison/each_item/memory.dart';
import 'package:test1/require_parts_comparison/each_item/motherboard.dart';
import 'package:test1/require_parts_comparison/each_item/power_suppy.dart';
import 'package:test1/require_parts_comparison/each_item/processor.dart';
import 'package:test1/require_parts_comparison/each_item/storage.dart';
import 'package:test1/require_parts_comparison/each_item/system_case.dart';

class TypesOfItemsCompare extends StatelessWidget {
  const TypesOfItemsCompare({Key? key}) : super(key: key);
