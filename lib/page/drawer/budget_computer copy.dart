...
class BudgetComputer2 extends StatefulWidget {
  const BudgetComputer2({
    Key? key,
  }) : super(key: key);

  @override
  State<BudgetComputer2> createState() => _BudgetComputerState();
}

class _BudgetComputerState extends State<BudgetComputer2> {
