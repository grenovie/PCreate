...
class _DetailsSystemCaseState extends State<DetailsProcessor> {
  ...
  Future<void> setSysProcessor(caseValue, imageValue, x1, x2, price, isDone,
      imageOrig, compatibleSocket) async {
    ...
    pref.setBool("isDoneCpu", isDone);
    pref.setString("cpuOrig", imageOrig);
    pref.setString('compatible_socket', compatibleSocket);
  }
}
